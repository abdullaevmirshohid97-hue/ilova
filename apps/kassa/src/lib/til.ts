...
const RU: Record<string, string> = {
  ...
  'Asosiy valyuta o‘zgaradi. Eski yozuvlar o‘z valyutasida qoladi.': 'Основная валюта изменится. Старые записи останутся в своей валюте.',
  'O‘zgartirish': 'Изменить',
  'Kurs noto‘g‘ri': 'Неверный курс',
  'Kurs noldan katta son bo‘lishi kerak': 'Курс должен быть больше нуля',
  'Bosh sahifadagi umumiy balans shu valyutada ko‘rsatiladi': 'Общий баланс на главной показывается в этой валюте',
  'Qo‘shimcha valyutalar': 'Дополнительные валюты',
  'Kurs faqat YANGI yozuvlarga qo‘llanadi — eskilari o‘zgarmaydi': 'Курс применяется только к НОВЫМ записям — старые не меняются',
  'Qo‘shimcha valyuta yo‘q': 'Дополнительных валют нет',
  'Kursni saqlash': 'Сохранить курс',
  'Valyuta va kurs': 'Валюта и курс',
  'Qachonga kelishdingiz': 'На какой срок договорились',
  'Qolganini qachonga kelishdingiz': 'На когда договорились об остатке',
  'Izoh:': 'Заметка:',
  'Summa:': 'Сумма:',
  'Kirim:': 'Приход:',
  'Muddat:': 'Срок:',
  ...
  '{n} kun': '{n} дн.',
  'Bo‘sh qoldirilsa muddat yo‘q': 'Пусто — без срока',
  ...
  'Sizga beramiz:': 'К оплате:',
  'hisobingiz:': 'ваш счёт:',
  'Kontaktlardan tanlash': 'Выбрать из контактов',
  'Kontakt bo‘sh': 'Контакт пустой',
  'Bu kontaktda ism ham, raqam ham yo‘q': 'В этом контакте нет ни имени, ни номера',
  'Kontakt ochilmadi': 'Контакты не открылись',
  'Cheklovdan oshdi': 'Превышен лимит',
  'Bo‘ladi:': 'Станет:',
  'Cheklov:': 'Лимит:',
  'Oshib ketdi:': 'Превышение:',
  'Bitimlar': 'Сделки',
  'Mijoz, izoh yoki summa': 'Клиент, заметка или сумма',
  ...
  'Bu filtrga mos mijoz yo‘q': 'По этому фильтру ничего нет',
  'Pastdagi «+ Mijoz» tugmasi bilan birinchisini qo‘shing': 'Добавьте первого кнопкой «+ Клиент»',
  '+ Mijoz qo‘shish': '+ Добавить клиента',
  'Jami haqlar': 'Всего к получению',
  'Jami qarzlar': 'Всего долгов',
  'TO‘LANDI': 'ОПЛАЧЕНО',
  'TO‘LADIM': 'Я ОПЛАТИЛ',
  'BEKOR': 'ОТМЕНА',
  'Mijoz, telefon yoki kategoriya': 'Клиент, телефон или категория',
  'Mijoz qo‘shish': 'Добавить клиента',
  ...
  'Balans cheklovi': 'Лимит баланса',
  'Barchasi': 'Все поля',
  'Manzil, kategoriya, cheklov, izoh': 'Адрес, категория, лимит, заметка',
  'Rasm qo‘shish': 'Добавить фото',
  'Rasmni almashtirish': 'Заменить фото',
  'Rasm yuklanmadi': 'Фото не загрузилось',
  'Mijoz rasmsiz saqlanadi': 'Клиент сохранится без фото',
  ...
  'Masalan: Bozor, Optom, Doimiy': 'Например: Рынок, Опт, Постоянный',
  'Masalan: 10 000 000': 'Например: 10 000 000',
  'Cheklovdan oshsa ogohlantiradi, lekin to‘smaydi': 'При превышении предупредит, но не заблокирует',
  'Bo‘sh qoldirilsa cheklov yo‘q': 'Пусто — без лимита',
  'Saqlanmadi': 'Не сохранено',
  'Mijozlar': 'Клиенты',
  'M': 'К',
  'Biznesni o‘chirasizmi?': 'Удалить бизнес?',
  'Bularni qaytarib bo‘lmaydi.': 'Это нельзя вернуть.',
  'O‘chmadi': 'Не удалено',
  'Nomini o‘zgartirish uchun biznesni bosing, o‘chirish uchun — savatni': 'Нажмите на бизнес, чтобы переименовать; на корзину — чтобы удалить',
  '{n} ta bitim': 'сделок: {n}',
  '{n} ta hamkor': 'партнёров: {n}',
  'Bekor': 'Отмена',
  'Biznes almashmadi': 'Бизнес не переключился',
  'Biznes qo‘shilmadi': 'Бизнес не добавлен',
  'Nom o‘zgarmadi': 'Название не изменилось',
  'Nomini o‘zgartirish uchun biznesni bosing': 'Нажмите на бизнес, чтобы переименовать',
  'Biznes yo‘q': 'Бизнесов нет',
  '+ Biznes qo‘shish': '+ Добавить бизнес',
  'Yangi biznes': 'Новый бизнес',
  'Yangi daftar ochiladi — eski biznesga tegmaydi': 'Откроется новая книга — старый бизнес не затронется',
  '{n} ta biznes': 'бизнесов: {n}',
  'Masalan: Baraka market': 'Например: Baraka market',
  'Saqlanmoqda…': 'Сохраняется…',
  'Kechikkan qarzlar': 'Просроченные долги',
  'Muddati o‘tgani yo‘q': 'Просроченных нет',
  'Hammasi muddatida': 'Всё в срок',
  'Kechikkan qarz yo‘q': 'Просроченных долгов нет',
  'Yangilash': 'Обновить',
  'Oldi-berdi daftari': 'Книга сделок',
  'Hujjat (PDF)': 'Документ (PDF)',
  'Tasdiqlash havolasi': 'Ссылка для подтверждения',
  'Bitim': 'Сделка',
  'Havola yaratilmadi': 'Ссылка не создана',
  'Bu bitim tasdiq kutmayapti': 'Эта сделка не ждёт подтверждения',
  'Internet kerak: havola serverda yaratiladi': 'Нужен интернет: ссылка создаётся на сервере',
  'Bot sozlanmagan — ishlab chiquvchiga ayting': 'Бот не настроен — сообщите разработчику',
  'Havola olinmadi': 'Ссылку получить не удалось',
  'oldi-berdimizni tasdiqlab bering.': 'подтвердите, пожалуйста, нашу сделку.',
  'Havola 7 kun ishlaydi.': 'Ссылка действует 7 дней.',
  'Hamkor': 'Партнёр',
  ...
  'Ilova ochilganda barmoq izi, PIN yoki chizma so‘raladi': 'При открытии приложения запрашивается отпечаток, PIN или графический ключ',
  'Yoqilgan': 'Включено',
  'O‘chirilgan': 'Выключено',
  'Daftarni ochish': 'Открыть журнал',
  'Daftar qulflangan': 'Журнал заблокирован',
