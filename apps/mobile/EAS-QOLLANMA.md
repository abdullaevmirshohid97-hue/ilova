...
- **"Would you like to create a project for @<sizning-akkaunt>/ilova-b2b?"** — Ha
...
- https://expo.dev/accounts/**sizning-akkaunt**/projects/ilova-b2b/builds
...
```
scp ilova-b2b.apk root@72.61.88.214:/var/www/ilova-app-landing/ilova-b2b.apk
```

(Agar fayl boshqa nom bilan yuklangan bo'lsa — serverga qo'yishdan oldin
`ilova-b2b.apk`ga nomlang.)
...
3. Yangi APK'ni xuddi shu yo'lga (`ilova-b2b.apk` nomi bilan) qo'ying —
