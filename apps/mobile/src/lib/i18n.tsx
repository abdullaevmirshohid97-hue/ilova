...
const uz = {
  ...
  loginNetworkError: "Serverga ulanib bo'lmadi. Internetni tekshiring yoki sahifani yangilang (Ctrl+Shift+R).",
  loginServerError: 'Serverda xatolik',
  loginButton: 'Kirish',
  ...
  filterTitle: 'Saralash va filtr',
  filterShowResults: '{n} ta mahsulotni ko`rish',
  nothingFoundTitle: 'Hech narsa topilmadi',
  nothingFoundHint: 'Filtrni tozalab qayta urinib ko`ring',
  filterBrand: 'Brend',
  brandLabel: 'Brend',
  // Bosh sahifa
  hello: 'Assalomu alaykum',
  helloName: 'Assalomu alaykum, {name}',
  youOwe: 'Sizning qarzingiz',
  weOwe: 'Sizning haqingiz',
  repeatTitle: 'Oxirgi buyurtmani takrorlash',
  repeatSubtitle: '№{num} · {n} ta qator',
  repeatButton: 'Takrorlash',
  repeatDone: '{n} ta mahsulot savatga qo`shildi',
  repeatPartial: '{n} ta mahsulot savatga qo`shildi, {m} tasi omborda yo`q yoki narxsiz',
  repeatNothing: 'Takrorlash uchun buyurtma topilmadi',
  ...
  invoiceSentTelegram: '✅ Faktura PDF ko`rinishida Telegram chatingizga yuborildi.',
  invoiceTitle: 'FAKTURA',
  invoiceOrderLabel: 'Buyurtma',
  invoiceDateLabel: 'Sana',
  invoiceCustomerLabel: 'Mijoz',
  invoiceManagerLabel: 'Menejer',
...
const ru: Record<keyof typeof uz, string> = {
  ...
  loginNetworkError: 'Не удалось подключиться к серверу. Проверьте интернет или обновите страницу (Ctrl+Shift+R).',
  loginServerError: 'Ошибка на сервере',
  loginButton: 'Войти',
  ...
  filterTitle: 'Сортировка и фильтр',
  filterShowResults: 'Показать {n} товаров',
  nothingFoundTitle: 'Ничего не найдено',
  nothingFoundHint: 'Очистите фильтр и попробуйте снова',
  filterBrand: 'Бренд',
  brandLabel: 'Бренд',
  hello: 'Здравствуйте',
  helloName: 'Здравствуйте, {name}',
  youOwe: 'Ваша задолженность',
  weOwe: 'Ваш аванс',
  repeatTitle: 'Повторить последний заказ',
  repeatSubtitle: '№{num} · {n} позиций',
  repeatButton: 'Повторить',
  repeatDone: '{n} товаров добавлено в корзину',
  repeatPartial: '{n} товаров добавлено, {m} нет в наличии или без цены',
  repeatNothing: 'Заказ для повтора не найден',
  bestSellers: 'Часто заказывают',
  newArrivals: 'Новые товары',
  seeAll: 'Смотреть все',
  minQty: 'Мин. {n} шт.',
  ...
  invoiceSentTelegram: '✅ Накладная в формате PDF отправлена в ваш чат Telegram.',
  invoiceTitle: 'НАКЛАДНАЯ',
  invoiceOrderLabel: 'Заказ',
  invoiceDateLabel: 'Дата',
  invoiceCustomerLabel: 'Клиент',
  invoiceManagerLabel: 'Менеджер',
