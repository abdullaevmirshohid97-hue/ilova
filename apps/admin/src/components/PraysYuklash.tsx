...
// ============================================================================
// PRAYS YUKLASH — sklad ichida ochiladi.
//
...
export default function PraysYuklash({ warehouseId, skladNomi, onYakun }: Props) {
  ...
  // Sklad prop bilan keladi: bu ekran skladning ICHIDA ochiladi,
  // shuning uchun "qaysi skladga" degan savol umuman tug'ilmaydi
  const sklad = warehouseId;
    ...
    <div style={{ fontFamily: MONO }}>
      ...
      >
        ...
        <div className="mt-2 text-[13px] font-bold" style={{ color: C.textBright }}>
          {skladNomi} uchun praysni shu yerga tashlang
        </div>
