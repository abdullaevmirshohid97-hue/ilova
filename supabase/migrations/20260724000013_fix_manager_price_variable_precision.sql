-- =============================================================
-- YUKCHIBOLLA — MUHIM XATO TUZATISHI: kasr dollar narxlar buyurtma
-- yaratilganda 0 ga yaxlitlanib ketardi.
--
-- 20260724000009 migratsiyasida manager_prices/manager_customer_prices/
-- order_items.orig_price ustunlari numeric(14,2) ga kengaytirilgan edi
-- (sent uchun), lekin create_order/admin_create_order/edit_order_items
-- funksiyalaridagi ICHKI o'zgaruvchilar (v_cust_price, v_mgr_price,
-- v_orig_price) hali eski numeric(14,0) turida qolib ketgan edi.
-- "select mcp.price into v_cust_price" qatorida Postgres qiymatni
-- avtomatik numeric(14,0)'ga cast qilgan — masalan $0.35 ni 0 ga
-- yaxlitlab yuborgan. Natijada dollarda narxlangan mahsulotlar 0 so'm/
-- 0 dollarga sotilib ketgan. Foydalanuvchi buni haqiqiy buyurtmada
-- ($0.35 narx 0 bo'lib chiqqan) aniqladi.
-- =============================================================
